...
About
-----
This project is a Proof of Concept for an Angular 2 application based on the official [Angular QuickStart](https://angular.io/docs/ts/latest/guide/setup.html) guide.

Credits
-------
The solution has been coded in [TypeScript](https://www.typescriptlang.org/) using [Visual Studio Code](https://code.visualstudio.com/).
